...
class CarControllerParams:
  ...
  ANGLE_RAMP_UP_TORQUE_REDUCTION_RATE =  0.006 #0.008  # Maximum rate at which torque can increase per control cycle.
  ANGLE_RAMP_DOWN_TORQUE_REDUCTION_RATE = 0.002 #0.0012  # Maximum rate at which torque can decrease per cycle
