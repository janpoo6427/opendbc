...
class CarControllerParams:
  ...
  ANGLE_LIMITS: AngleSteeringLimits = AngleSteeringLimits(
    ...
    MAX_LATERAL_JERK=(1.8 + (ACCELERATION_DUE_TO_GRAVITY * AVERAGE_ROAD_ROLL)),  # ~3.6 m/s^3,
  ...
  # try 1
  ANGLE_MAX_TORQUE_REDUCTION_GAIN = 0.55 #0.65    # 기존 1.0 → 0.65 (35% 감소)
  ...
  # try 1
  ANGLE_RAMP_UP_TORQUE_REDUCTION_RATE = 0.0025 # 0.003
  ANGLE_RAMP_DOWN_TORQUE_REDUCTION_RATE = 0.0025 #0.004
